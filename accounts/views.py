...
from .models import templates_directory
...
class ResendOTP(View):
	def get(self, request, user_id):
		...
		email_content = get_html_content(template_path, otp_absolute_url=otp_absolute_url, domain=domain)
		...
		return HttpResponse("Emailinizə hesabınızı təsdiqləmək üçün link yenidən göndərildi!")